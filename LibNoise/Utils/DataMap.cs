...
namespace LibNoise.Utils
{
    ...
    public abstract class DataMap<T> where T : IEquatable<T>
	{
	    ...
	    /// </summary>
	    public float MemoryUsageKb => MemoryUsage / 8192.0f;

	    /// <summary>
	    ///     Gets the memory used (in Kb) for this map.
	    /// </summary>
	    public float MemoryUsageMo => MemoryUsage / 8388608.0f;
	    ...
	    public void CopyTo(ref T[] buffer)
		{
			...
			var size = _data.Length > buffer.Length ? buffer.Length : _data.Length;
