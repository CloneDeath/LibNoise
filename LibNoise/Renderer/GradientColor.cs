...
namespace LibNoise.Renderer
{
    ...
    public class GradientColor
	{
	    ...
	    public IColor GetColor(float position)
		{
			...
			var index0 = Libnoise.Clamp(indexPos - 1, 0, _gradientPoints.Count - 1);
			var index1 = Libnoise.Clamp(indexPos, 0, _gradientPoints.Count - 1);
			...
			var input0 = _gradientPoints[index0].Position;
			var input1 = _gradientPoints[index1].Position;
